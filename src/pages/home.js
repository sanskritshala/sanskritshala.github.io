  ...
  return <div className='home' >
      ...
      <div className='content'>
              <div style={{display:'inline-block'}} >
                  ...
                  <Cards onClick={()=>{window.location.href='http://cnerg.iitkgp.ac.in/sandp/'}} vid='tile5' title="Dependency Parser" vcolor1="rgba(93, 173, 226)" vcolor2="rgba(214, 234, 248, 0.041)" />
                  <Cards onClick={()=>{navigate('/dp')}} vid='tile3' title="Dependency Annotator" vcolor1="rgba(69, 179, 157)" vcolor2="rgba(209, 242, 235, 0.041)" />
